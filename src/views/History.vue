<template>
 <div class="space-y-4">
 <header class="rounded-2xl bg-surface shadow p-4 grid grid-cols-3 text-center">
 <div>
 ...
 <section v-for="day in grouped" :key="day.date" class="rounded-2xl bg-surface shadow p-4">
 <h3 class="text-sm font-semibold text-ink-soft mb-2">{{ day.date }}</h3>
 <ul class="divide-y">
 <li
